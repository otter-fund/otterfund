...
import { SkeletonPage, Skel, SkelHero, SkelCard, SkelBarList } from "@/components/otterfund/skeleton";
      ...
      <Card className="p-6">
        ...
        {[0, 1, 2].map((g) => (
          <div key={g} className="mt-5">
            ...
            {[0, 1].map((r) => (
              <div key={r} className="flex items-center justify-between border-t border-[var(--color-of-line-soft)] py-2.5">
