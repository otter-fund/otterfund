...
export const MERCHANT_DICTIONARY: Record<string, DictionaryEntry> = {
  ...
  "prime video": { displayName: "Prime Video", domain: "amazon.com" },
  "apple music": { displayName: "Apple Music", domain: "apple.com" },
  "apple tv": { displayName: "Apple TV+", domain: "apple.com" },
  "apple tv plus": { displayName: "Apple TV+", domain: "apple.com" },
  icloud: { displayName: "iCloud+", domain: "apple.com" },
  "icloud plus": { displayName: "iCloud+", domain: "apple.com" },
  ...
  "amazon music": { displayName: "Amazon Music", domain: "amazon.com" },
