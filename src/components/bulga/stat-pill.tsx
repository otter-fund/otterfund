...
// Bulga — <StatPill>. The one rounded-full "figure + label" pill used across the
...
// hand-rolled the pill: a serif `.bk-num` figure next to a sans label needs its
...
export function StatPill({
  ...
  return (
    ...
    >
      ...
      <span className="bk-num" style={{ fontWeight: 600 }}>
        {figure}
      </span>
