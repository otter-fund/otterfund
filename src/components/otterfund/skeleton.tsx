...
/** Page root: keeps the of-page column and announces loading to AT. */
export function SkeletonPage({ children }: { children: React.ReactNode }) {
  return (
    <div className="of-page" role="status" aria-label="Loading page">
      {children}
    </div>
  );
}
...
export function SkelHero({
  ...
  return (
    <section className="of-hero-row flex items-end justify-between gap-7 px-1 pb-8">
      <div>
      ...
      {Array.from({ length: rows }, (_, i) => (
        <div
          ...
          className={cn(
            ...
            divided && i > 0 && "border-t border-[var(--color-of-line-soft)]"
          )}
        >
