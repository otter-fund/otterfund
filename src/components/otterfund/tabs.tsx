...
// otterfund tabs — vertical/horizontal tab rail. The active tab is a solid
// dark-accent pill, matching the app's icon-rail (RailLink in otterfund-chrome).
        ...
        return (
          <button
            ...
            className={cn(
              ...
              active
                ? "text-white"
                : "text-[var(--color-of-muted)] hover:bg-[var(--color-of-line-soft)] hover:text-[var(--color-of-ink)]"
            )}
